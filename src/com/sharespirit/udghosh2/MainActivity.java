...
public class MainActivity extends SherlockActivity implements ISideNavigationCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Boolean sn= in.getBooleanExtra("slow", false);
        
        if(sn)
        {
        	Toast.makeText(getApplicationContext(), "Couldn't Register-Internet too slow :(", Toast.LENGTH_SHORT).show();
...
//								}
	...
	void instructions()
	{
		...
		contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
		contact.put(TAG_INFO, "Welcome to Udghosh<Team Udghosh>");
		adapter.addItem(contact, false);
		
		
		 contact = new HashMap<String, String>();
			contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
			contact.put(TAG_INFO, "Report bugs about the app at raghuth@iitk.ac.in<Team Udghosh>");
			adapter.addItem(contact, false);
		 ...
		 contact = new HashMap<String, String>();
		contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
		contact.put(TAG_INFO, "Pull down this list for updates<Team Udghosh>");
		adapter.addItem(contact, false);
		 ...
		 contact = new HashMap<String, String>();
			contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
			contact.put(TAG_INFO, "Visit the News section for new notification/news<Team Udghosh>");
			adapter.addItem(contact, false);
			
			
			 contact = new HashMap<String, String>();
				contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
				contact.put(TAG_INFO, "Use Navigation maps for directions<Team Udghosh>");
				adapter.addItem(contact, false);
				
				
				 contact = new HashMap<String, String>();
					contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
					contact.put(TAG_INFO, "Use Athenticated Internet to access online features of this app<Team Udghosh>");
					adapter.addItem(contact, false);
						 ...
						 contact = new HashMap<String, String>();
							contact.put(TAG_URL, "drawable://" + R.drawable.ic_stub);
							contact.put(TAG_INFO, "For any help refer to the Control Desk-New Sac<Team Udghosh>");
							adapter.addItem(contact, true);
...
//            	startActivity(in3);
            	...
            	Intent in7=new Intent(getApplicationContext(), FoodCourts.class);
            	startActivity(in7);
